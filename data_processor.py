...
class DataProcessor:
    def __init__(self, db_path=None):
        ...
        self.all_items = [
            ...
            # 棚卸資産の詳細
            "製品", "副産物作業くず", "半製品", "原材料", "仕掛品",

            # 他流動資産の詳細
            "前渡金", "繰延税金資産(流)", "未収収益", "短期貸付金", "預け金",
            "仮払消費税等", "貸倒引当金(他)", "修正申告調整勘定",

            # 有形固定資産の詳細
            "建物", "構築物", "機械装置", "工具器具備品", "一括償却資産",
            "減価償却累計額", "土地", "建設仮勘定",
            ...
            # 投資その他の資産の詳細
            "関係会社出資金", "長期固定性預金", "前払年金費用", "繰延税金資産(固)",
            "預託金", "貸倒引当金(投)",
            ...
            # 流動負債の詳細
            "支払手形", "設備支払手形", "未払配当金", "未払役員賞与",
            "繰延税金負債(流)", "前受金", "前受収益", "預り保証金",
            "割引手形", "裏書手形", "仮受消費税等",

            # 固定負債の詳細
            "長期未払金", "繰延税金負債(固)", "退職給付引当金",

            # 純資産の詳細
            "資本金合計", "新株式申込証拠金", "新株式申込証拠金合計",
            "資本準備金", "資本準備金合計", "資本金及び準備金減少差益",
            "自己株式処分差額", "その他資本剰余金合計", "資本剰余金合計",
            "利益準備金合計", "別途積立金", "任意積立金合計",
            "繰越利益", "繰越利益剰余金合計", "その他利益剰余金合計",
            "利益剰余金合計", "自己株式", "自己株式合計",
            "自己株式申込証拠金", "自己株式申込証拠金合計",
            "株主資本合計", "その他有価証券評価差額金", "繰延ヘッジ損益",
            "土地再評価差額金", "評価･換算差額等合計",
            "新株予約権", "新株予約権合計",
        ]
