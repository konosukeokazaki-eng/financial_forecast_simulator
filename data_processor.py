...
class DataProcessor:
    def __init__(self, db_path=None):
        ...
        self.all_items = [
            ...
            "有価証券合計",
            "商品", "貯蔵品", "棚卸資産合計",
            "立替金", "前払費用", "未収入金", "仮払金", "仮払消費税", "仮払法人税等",
            "他流動資産合計", "流動資産合計",
            ...
            "投資その他の資産計", "固定資産合計", "資産合計",
            
            # 流動負債
            "買掛金", "仕入債務合計", "短期借入金", "未払金", "未払費用",
            "未払法人税等", "未払消費税等", "預り金", "仮受金", "仮受消費税",
            "他流動負債合計", "流動負債合計",
            
            # 固定負債
            "長期借入金", "他固定負債合計", "固定負債合計", "負債合計",
            
            # 純資産
            "資本金", "資本剰余金", "利益準備金", "繰越利益剰余金",
            "当期未処分利益", "株主資本計", "純資産合計", "負債･純資産合計"
        ]
